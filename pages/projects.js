                    ...
                    <div className="text-md text-gray-500">
                      <div>
                        ...
                        {project.tags.map((tag, tagId) => (
                          <span
                            key={tagId}
                            className="mr-2 my-0.5 relative inline-flex items-center bg-white rounded-full border bprder-gray-300 px-3">
                            <div className="absolute flex-shrink-0 flex items-center justify-center">
                              <span
                                className="h-1.5 w-1.5 roudned-full bg-green-500"
