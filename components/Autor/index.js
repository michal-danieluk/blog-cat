...
export default function Autor() {
  return (
    <section className="z-0 flex flex-col sm:flex-row justify-center max-w-full p-10 mx-auto text-gray-200 bg-gray-800 ">
      ...
      <article className="m-2 p-2 shadow ring-yellow-500  rounded-bl-lg rounded-tr-lg rounded-tl-lg  ring">
        <Image
          src="/head_1.jpeg"
          // layout="fill"
          width={308}
